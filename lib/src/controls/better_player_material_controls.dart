...
class _BetterPlayerMaterialControlsState extends BetterPlayerControlsState<BetterPlayerMaterialControls> {
  ...
  Future<void> _initializeDeviceVolume() async {
    if (!_volumeInitialized) {
      try {
        ...
        BetterPlayerUtils.log('🎯 BetterPlayer: Device volume initialized to $_currentDeviceVolume');
        if (mounted) {
          setState(() {});
        }
      } catch (e) {
  ...
  void _onVolumeChanged(double volume) {
    BetterPlayerUtils.log('🎯 BetterPlayer: _onVolumeChanged called with $volume');
    setState(() {
          ...
          ? AnimatedOpacity(
              ...
              child: SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    Row(children: [_buildBackButton(), _buildHideUnhide(betterPlayerController!)]),
  ...
  Widget _buildBackButton() => BetterPlayerMaterialClickableWidget(
  ...
  Widget _buildResizeButton() => BetterPlayerMaterialClickableWidget(
  ...
  Widget _buildCastButton() => BetterPlayerMaterialClickableWidget(
    onTap: () {
      if (_controlsConfiguration.onCastTap != null) {
        _controlsConfiguration.onCastTap?.call();
      }
    },
    child: Padding(
      padding: const EdgeInsets.all(8),
  ...
  Widget _buildServerButton() => BetterPlayerMaterialClickableWidget(
    onTap: () {
      if (_controlsConfiguration.onServerTap != null) {
        _controlsConfiguration.onServerTap?.call();
      }
    },
    child: Padding(
      padding: const EdgeInsets.all(8),
  ...
  Widget _buildEpisodeSelectionButton() => Padding(
  ...
  Widget _buildMovieRecommendationsButton() => Padding(
    padding: const EdgeInsets.only(right: 8),
    child: BetterPlayerMaterialClickableWidget(
      onTap: () {
  ...
  Widget _buildHitAreaClickableButton({Widget? icon, required VoidCallback onClicked, bool? isFocused}) => Container(
  ...
  Widget _buildForwardButton() => Focus(
    child: Builder(
      builder: (context) {
        final bool isFocused = Focus.of(context).hasFocus;
        return _buildHitAreaClickableButton(
  ...
  Widget _buildHideUnhide(BetterPlayerController controller) => BetterPlayerMaterialClickableWidget(
    onTap: _onHideUnHide,
    child: Container(
      height: double.infinity,
      margin: const EdgeInsets.symmetric(horizontal: 4),
  ...
  Widget _buildPosition() {
    ...
    final String formattedTotalDuration = BetterPlayerUtils.formatDuration(duration);
    final String formattedRemainingDuration = '-${BetterPlayerUtils.formatDuration(remaining)}';
      ...
      child: Row(
        children: [
          Text(
            ...
            style: TextStyle(fontSize: 11, color: _controlsConfiguration.textColor, decoration: TextDecoration.none),
          ),
          GestureDetector(
            onTap: () {
